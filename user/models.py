...
class FileUpload(Base):
    ...
    @transition(field=status, source=[FILE_STATUS_PENDING, FILE_STATUS_PROCESSING], target=FILE_STATUS_FAILED)
    def mark_failed(self):
        pass

    @transition(field=status, source=FILE_STATUS_PROCESSING, target=FILE_STATUS_PROCESSED)
    def mark_processed(self):
        pass

    @transition(field=status, source=[FILE_STATUS_PROCESSING, FILE_STATUS_PROCESSED], target=FILE_STATUS_FAILED)
